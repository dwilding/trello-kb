...
| _header_      | <p>For each level 1 header in the card description:</p><ul><li>an HTML version of the content that follows the header; or</li><li>an object corresponsing to the YAML code block following the header.</li></ul><p>See [Main Features](#main-features).</p><p>You can use the [keyFromText](#keyfromtext) option to control how Trello KB converts header text to property names.</p> |
